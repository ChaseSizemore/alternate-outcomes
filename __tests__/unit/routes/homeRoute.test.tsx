...
describe('Home Component', () => {
  ...
  it('renders the Home component correctly', () => {
    ...
    expect(
      screen.getByText(
        'Alternate Outcomes made simple for future Software Engineers.'
      )
    ).toBeInTheDocument();
  ...
  it('renders the alert message', () => {
    render(<Home />);
    const alertMessage =
      'This site is not affiliated with any bootcamps listed. All data is user submitted. Please do your own research before enrolling or applying in a bootcamp.';
  ...
  it('displays the correct heading and subheading', () => {
    ...
    expect(
      screen.getByText(/Bootcamps and self teaching can be a great choice/)
    ).toBeInTheDocument();
  });
